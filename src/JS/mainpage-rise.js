let currentBaseMonsters = baseRiseMonsters;
...
let currentExpansionMonsters = expansionSunbreakMonsters;
        ...
        baseMonsterGrid.innerHTML += `
            <div class="monster-card">
                ...
                <div class="monster-name">
                    <a href="infopage-rise.html?id=${monster.id}">${monster.name}</a>
...
displayBaseMonsters(baseRiseMonsters);
...
displayExpansionMonsters(expansionSunbreakMonsters);
/* =========================
   SEARCH
========================= */
